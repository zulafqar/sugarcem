<?php /* Smarty version 2.6.11, created on 2017-03-03 11:43:20
         compiled from cache/modules/cm_custom_module/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/cm_custom_module/DetailView.tpl', 33, false),array('function', 'sugar_translate', 'cache/modules/cm_custom_module/DetailView.tpl', 40, false),array('function', 'counter', 'cache/modules/cm_custom_module/DetailView.tpl', 45, false),array('function', 'sugar_ajax_url', 'cache/modules/cm_custom_module/DetailView.tpl', 168, false),array('function', 'sugar_getjspath', 'cache/modules/cm_custom_module/DetailView.tpl', 206, false),array('modifier', 'strip_semicolon', 'cache/modules/cm_custom_module/DetailView.tpl', 55, false),array('modifier', 'escape', 'cache/modules/cm_custom_module/DetailView.tpl', 143, false),array('modifier', 'url2html', 'cache/modules/cm_custom_module/DetailView.tpl', 143, false),array('modifier', 'nl2br', 'cache/modules/cm_custom_module/DetailView.tpl', 143, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cm_custom_module'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cm_custom_module'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cm_custom_module'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='cm_custom_module'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div id="cm_custom_module_detailview_tabs"
class="yui-navset detailview_tabs"
>

<ul class="yui-nav">

<li><a id="tab0" href="javascript:void(0)"><em><?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'cm_custom_module'), $this);?>
</em></a></li>
</ul>
...
<?php $this->assign('value', "03/03/2017"); ?>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['custom_account']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
"><?php echo $this->_tpl_vars['fields']['custom_account']['value']; ?>
</span>
...
var cm_custom_module_detailview_tabs = new YAHOO.widget.TabView("cm_custom_module_detailview_tabs");
cm_custom_module_detailview_tabs.selectTab(0);
</script>