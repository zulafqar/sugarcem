<?php /* Smarty version 2.6.11, created on 2017-03-06 07:20:18
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_reports_to_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_advanced","reports_to_id_advanced"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_cm_custom_module_users_name_advanced\']={"form":"popup_query_form","method":"query","modules":["cm_custom_module"],"group":"or","field_list":["name","id"],"populate_list":["cm_custom_module_users_name_advanced","cm_custom_module_userscm_custom_module_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>