/*
 ...
 build: 3167
 */
YUI.add('anim-easing',function(Y){var Easing={easeNone:function(t,b,c,d){return c*t/d+b;},easeIn:function(t,b,c,d){return c*(t/=d)*t+b;},easeOut:function(t,b,c,d){return-c*(t/=d)*(t-2)+b;},easeBoth:function(t,b,c,d){if((t/=d/2)<1){return c/2*t*t+b;}
...
return Y.Easing.bounceOut(t*2-d,0,c,d)*0.5+c*0.5+b;}};Y.Easing=Easing;},'3.3.0',{requires:['anim-base']});